    ...
    <section>
        ...
        <div class="row">
            <div class="col xlarge-3 large-4 medium-6">
                ...
                <ul class="text-secondary">
                    <li>80x80: css class <code class="hljs-css-class">.thumbnail.md-80</code></li>
                    <li>120x120: css class <code class="hljs-css-class">.thumbnail.md-120</code></li>
                    <li>160x160: css class <code class="hljs-css-class">.thumbnail.md-160</code></li>
                </ul>
            </div>
...
TEXT
        ...
        <div class="row">
            <div class="col xlarge-3 large-4 medium-6">
                ...
                <p class="text-secondary">Default media aspect ratio is 16:9, as an option it can be 1:1 by using the css class <code class="hljs-css-class">.media.md-1by1</code></p>
            </div>
            <div class="col xlarge-5 large-6 medium-10">
<pre class="bg-app-bar html"><?= htmlspecialchars(
<<<TEXT
